...
public static class AdaptHelper 
{
    ...
    public static IMethod GetMethod(this ILType type, AdaptMethod m)
    {
        ...
        if (m.Method == null)
        {
            ...
            throw new Exception(string.Format("cant find method:{0},{1}:{2},paramCount={3}",type.FullName,m.Name,baseClass,m.ParamCount));
        }
        return m.Method;
    }
}
...
public abstract class MyAdaptor : CrossBindingAdaptorType
{
    ...
    protected MyAdaptor(ILRuntime.Runtime.Enviorment.AppDomain _AppDomain , ILTypeInstance _TempInstance)
    {
